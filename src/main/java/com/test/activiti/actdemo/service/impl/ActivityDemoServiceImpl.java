package com.test.activiti.actdemo.service.impl;
...
public class ActivityDemoServiceImpl {
    ...
    public void startProcesses(String bizId) {
        ...
        variable.put("submitMan","提交人姓名");
        ProcessInstance pi = runtimeService.startProcessInstanceByKey("myProcess", bizId,variable);//流程图id，业务表id
    ...
    public void completeTask(String taskId,String userId,String result) {
        ...
        taskService.addComment(taskId,null,"审核通过");

        Map<String,Object> vars = new HashMap<String,Object>();
        vars.put("sign", result);
        vars.put("reason","审核通过");
    ...
    public void queryProImg(String processInstanceId) throws Exception {
        ...
        File file = new File("D:\\demov4.png");
